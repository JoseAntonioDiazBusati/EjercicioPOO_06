 ...
 *
 * Las clases Compra, Cliente y Domicilio se establecerán como data class, es decir,
 * delante de class incluirán el modificador data en la declaración de dichas clases.
 *
 ...
 *  */
 * La clase RepositorioCompras tendrá un método para agregar una compra al repositorio y un método domicilios
 * para retornar los domicilios de cada cliente al cual se le debe enviar una factura de compra. Esta función
 * retorna una estructura que contenga cada domicilio una sola vez.
 */
fun main() {
    println("Hello World!")
}